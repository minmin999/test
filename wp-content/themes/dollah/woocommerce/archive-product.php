...
dollah_display_loop_title_content( 'pre', 'archive-product.php' );
if ( dollah_page_header_attop() ) {
	...
	dollah_display_loop_title_content( 'post', 'archive-product.php' );
}

// Template modification Hook
do_action( 'dollah_template_before_content_grid', 'archive-product.php' );
?>
...
<div class="hgrid main-content-grid">
	...
	<?php
	// Template modification Hook
	do_action( 'dollah_template_before_main', 'archive-product.php' );
	?>
	...
	<main <?php hybridextend_attr( 'content' ); ?>>
		...
		<?php
		// Template modification Hook
		do_action( 'dollah_template_main_start', 'archive-product.php' );
		...
		if ( have_posts() ) :
			...
			<div id="content-wrap">
				...
				// Template modification Hook
				do_action( 'dollah_template_before_loop_nav', 'archive-product.php' );
		...
		// Template modification Hook
		do_action( 'dollah_template_main_end', 'archive-product.php' );
		?>
	...
	<?php
	// Template modification Hook
	do_action( 'dollah_template_after_main', 'archive-product.php' );
