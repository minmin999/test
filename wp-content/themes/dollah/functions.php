...
$dollah_base_dir = trailingslashit( get_template_directory() );

/* Load the Core framework and theme files */
require_once( $dollah_base_dir . 'hybrid/hybrid.php' );
require_once( $dollah_base_dir . 'hybrid/extend/extend.php' );
require_once( $dollah_base_dir . 'include/hoot-theme.php' );

/* Framework and Theme Setup files loaded */
do_action( 'dollah_loaded' );
...
/* Launch the Theme */
$dollah_theme = new Dollah_Theme();

/* Hoot Theme Setup complete */
do_action( 'dollah_theme_after_setup' );