 ...
 */
$display_loop_meta = apply_filters( 'dollah_woo_loop_meta', true );
do_action ( 'dollah_woo_loop_meta', 'start' );
...
if ( !is_product() && !is_singular() ) :
	...
	$display_title = apply_filters( 'dollah_wooloop_meta_display_title', true, 'plural' );
...
elseif ( is_product() ) :
	...
	add_filter( 'dollah_loop_meta_display_title', 'dollah_hide_loop_meta_woo_product' );
 ...
 * Template modification Hooks
 */
do_action ( 'dollah_woo_loop_meta', 'end' );