...
<article <?php hybridextend_attr( 'post', '', 'archive-block archive-block2 hcolumn-1-2' ); ?>>
	...
	<div class="entry-grid hgrid">
		...
		<?php $img_size = apply_filters( 'dollah_post_image_archive_block2', 'hoot-large-thumb' );
		...
		<div class="entry-grid-content">
			...
			<?php dollah_meta_info_blocks( dollah_get_mod('archive_post_meta'), 'archive-block2' ); ?>
