...
class Fluid_Magazine_Social_Networks extends WP_Widget {
	...
	public function widget( $args, $instance ) {
        ...
        ?>
            <ul class="social-networks">
				<?php if( $facebook ){ ?>
                <li><a href="<?php echo esc_url( $facebook ); ?>" target="_blank" title="<?php esc_attr_e( 'Facebook', 'fluid-magazine' ); ?>" class="fa fa-facebook"></a></li>
				<?php } if( $twitter ){ ?>
                <li><a href="<?php echo esc_url( $twitter ); ?>" target="_blank" title="<?php esc_attr_e( 'Twitter', 'fluid-magazine' ); ?>" class="fa fa-twitter"></a></li>
                <?php } if( $google_plus ){ ?>
                <li><a href="<?php echo esc_url( $google_plus ); ?>" target="_blank" title="<?php esc_attr_e( 'Google Plus', 'fluid-magazine' ); ?>" class="fa fa-google-plus"></a></li>
                <?php } if( $linkedin ){ ?>
                <li><a href="<?php echo esc_url( $linkedin ); ?>" target="_blank" title="<?php esc_attr_e( 'Linkedin', 'fluid-magazine' ); ?>" class="fa fa-linkedin"></a></li>
                <?php } if( $pinterest ){ ?>
                <li><a href="<?php echo esc_url( $pinterest ); ?>"  target="_blank" title="<?php esc_attr_e( 'Pinterest', 'fluid-magazine' ); ?>" class="fa fa-pinterest-p"></a></li>
                <?php } if( $instagram ){ ?>
                <li><a href="<?php echo esc_url( $instagram ); ?>" target="_blank" title="<?php esc_attr_e( 'Instagram', 'fluid-magazine' ); ?>" class="fa fa-instagram"></a></li>
                <?php } if( $youtube ){ ?>
                <li><a href="<?php echo esc_url( $youtube ); ?>" target="_blank" title="<?php esc_attr_e( 'YouTube', 'fluid-magazine' ); ?>" class="fa fa-youtube"></a></li>
                <?php } if( $ok ){ ?>
                <li><a href="<?php echo esc_url( $ok ); ?>" target="_blank" title="<?php esc_attr_e( 'OK', 'fluid-magazine' ); ?>" class="fa fa-odnoklassniki"></a></li>
                <?php } if( $vk ){ ?>
                <li><a href="<?php echo esc_url( $vk ); ?>" target="_blank" title="<?php esc_attr_e( 'VK', 'fluid-magazine' ); ?>" class="fa fa-vk"></a></li>
                <?php } if( $xing ){ ?>
                <li><a href="<?php echo esc_url( $xing ); ?>" target="_blank" title="<?php esc_attr_e( 'Xing', 'fluid-magazine' ); ?>" class="fa fa-xing"></a></li>
                <?php } ?>
			</ul>
        <?php
	...
	public function form( $instance ) {
        ...
        <p>
            <label for="<?php echo $this->get_field_id( 'ok' ); ?>"><?php _e( 'OK', 'fluid-magazine' ); ?></label> 
        ...
        <p>
            <label for="<?php echo $this->get_field_id( 'vk' ); ?>"><?php _e( 'VK', 'fluid-magazine' ); ?></label> 
        ...
        <p>
            <label for="<?php echo $this->get_field_id( 'xing' ); ?>"><?php _e( 'Xing', 'fluid-magazine' ); ?></label> 
