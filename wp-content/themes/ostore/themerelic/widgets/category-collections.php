        ...
        if($ostore_collection_style == 'style1'): ?>
            <div class="ostore-bottom-banner-section">   
                ...
                <?php  foreach($ostore_collection_id as $ostore_cat => $cat_name){ 
                    ...
                    if($term == null){
                        $term = (object) array('name'=>'default','slug'=>'','description'=>'');

                        //term links hear
                        $category_links = '';
                    }else{
                        $category_links = get_term_link(intval($ostore_cat), 'product_cat');
                    }
                ...
                ?>
                    <div class="col-md-4 col-sm-4"> 
                        <a href="<?php echo esc_url($category_links); ?>" class="ostore-bottom-banner-img">
                            <div class="overimg">
        ...
        <div class="ostore-bottom-banner-section">   
                ...
                foreach($ostore_collection_id as $ostore_cat => $cat_name){ 
                    ...
                    if($term == null){
                        ...
                        $link = get_term_link(intval($ostore_cat), 'product_cat');
                    }
                ...
                <?php endif; ?>
                    <a href="<?php echo esc_url($link); ?>" class="ostore-bottom-banner-img">
                    <div class="overimg"> 
