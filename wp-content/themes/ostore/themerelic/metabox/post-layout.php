...
class Ostore_Post_Layout{
    ...
    public function ostore_meta_box_cb()
    {
        ...
        ?>
        <p><?php esc_html_e('Choose from following layout:','ostore'); ?><hr/>
            <input type="radio" name="layout" value="left-sidebar" <?php checked( $layout, 'left-sidebar' ); ?>><?php esc_html_e('Left Sidebar','ostore'); ?>
            <input type="radio" name="layout" value="right-sidebar" <?php checked( $layout, 'right-sidebar' ); ?>><?php esc_html_e('Right Sidebar','ostore'); ?>
            <input type="radio" name="layout" value="full-width" <?php checked( $layout, 'full-width' ); ?>><?php esc_html_e('Full Width','ostore'); ?>
            <input type="radio" name="layout" value="both-sidebar" <?php checked( $layout, 'both-sidebar' ); ?>><?php esc_html_e('Both Sidebar','ostore'); ?>
        </p>
