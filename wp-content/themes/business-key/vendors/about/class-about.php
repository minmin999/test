	...
	class Business_Key_About {
		...
		public function load_assets( $hook ) {
			...
			if ( 'appearance_page_' . $this->page_slug === $hook ) {
				...
				wp_enqueue_style( 'business-key-about', get_template_directory_uri() . '/vendors/about/css/about' . $min . '.css', array(), '1.0.1' );
				wp_enqueue_script( 'business-key-about', get_template_directory_uri() . '/vendors/about/js/about' . $min . '.js', array( 'jquery' ), '1.0.1' );
				$js_vars = array(
