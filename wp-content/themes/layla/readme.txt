...
= How many menu items does Layla support ?

Layla supports an unlimited number of menu items, it has been optimized for top-level menus, sub menus and sub-sub menus.
