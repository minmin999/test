...
<?php do_action( 'vw_hospital_lite_above_service' ); ?>
						...
						<div class="col-md-3 col-sm-3">
							<div class="service-main-box">
							    ...
							    <div class="box-content text-center">
							        ...
							        <a class="r_button"  href="<?php the_permalink(); ?>"><?php esc_html_e('READ MORE','vw-hospital-lite'); ?></a>
							    </div>
							</div>
						</div>
					<?php $count++; endwhile; 
...
<?php do_action( 'vw_hospital_lite_above_content' ); ?>
