...
function vw_fitness_customize_preview_js() {
	wp_enqueue_script( 'vw-fitness-customizer', get_template_directory_uri() . '/js/logo/customize-preview.js', array( 'jquery', 'customize-preview' ), '201709081119', true );
}
...
function vw_fitness_customize_controls_js() {
		wp_enqueue_script( 'vw-fitness-customizer-controls', get_template_directory_uri() . '/js/logo/customize-controls.js', array( 'jquery', 'customize-preview' ), '201709071000', true );
}
 ...
 */
function vw_fitness_customize_css() {
	wp_add_inline_style( 'customize-controls', '#customize-control-logo_size input[type=range] { width: 100%; }' );
}
add_action( 'customize_controls_enqueue_scripts', 'vw_fitness_customize_css' );
