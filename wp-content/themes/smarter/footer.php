...
?>
		...
		<?php /* Sidebar */ smarter_thinkup_sidebar_html(); ?>
	</div>
	</div><!-- #content -->

	<footer>
		<?php /* Custom Footer Layout */ smarter_thinkup_input_footerlayout();
		echo	'<!-- #footer -->';  ?>
		...
		<div id="sub-footer-core">	
			...
			<div class="copyright">
			<?php /* === Add custom footer === */ smarter_thinkup_input_copyright(); ?>
			</div>
			<!-- .copyright -->
